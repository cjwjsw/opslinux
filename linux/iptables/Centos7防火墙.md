...
# Generated by iptables-save v1.4.21 on Thu May 30 19:25:29 2019
*filter
:INPUT DROP [0:0]
:FORWARD DROP [0:0]
:OUTPUT ACCEPT [2:312]
-A INPUT -s 192.168.52.0/24 -p tcp -m tcp --dport 3306 -j ACCEPT
-A INPUT -i lo -j ACCEPT
-A INPUT -p tcp -m tcp --dport 33389 -j ACCEPT
-A INPUT -s 192.168.52.0/24 -p tcp -m multiport --dports 8080:8090 -j ACCEPT
-A INPUT -p tcp -m multiport --dports 21:22,80,443 -j ACCEPT
-A INPUT -p icmp -m icmp --icmp-type 8 -j ACCEPT
-A INPUT -m state --state NEW,RELATED,ESTABLISHED -j ACCEPT
COMMIT
# Completed on Thu May 30 19:25:29 2019
EOF
```
